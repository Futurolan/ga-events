        ...
        <div className='section'>
          ...
          <div className='container has-text-centered'>
            <div className='content'>
              <p>
                <a className='button is-primary' rel='noopener noreferrer' target='_blank' title='Lien vers le formulaire de recrutement' href={config.recruit.formUrl}>Voir le formulaire dans un nouvel onglet</a>
              </p>
